                ...
                <form action="{{ route('admin.discount-codes.store') }}" method="POST">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="type_fixed" value="fixed"
                                    {{ old('type', 'fixed') === 'fixed' ? 'checked' : '' }} required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount"
                            name="amount" step="0.01" min="0.01" max="9999.99" placeholder="10.00"
                    ...
                    <div class="mb-3" id="max_uses_container" style="display: none;">
                        ...
                        <input type="number" class="form-control @error('max_uses') is-invalid @enderror" id="max_uses"
                            name="max_uses" min="1" placeholder="Onbeperkt" value="{{ old('max_uses') }}">
